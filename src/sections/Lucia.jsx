...
const Lucia = () => {
  ...
  return (
    <section className="lucia-life">
        <div className="flex flex-col gap-5 items-end ps-10 lg:1/2 mt-96 img-box">
            <div className="lucia-1">
                <img src="/images/lucia-1.webp" alt="jason-1" />
            </div>
             <div className="lucia-3">
                <img src="/images/lucia-3.webp" alt="jason-3" />
            </div>
        </div>
        ...
        <div className="max-w-xl lg:ps-32 ps-10">
          ...
          <p>
            ...
            <div className="lucia-2">
                <img src="/images/lucia-2.webp" alt="jason"  />
            </div>
            ...
            <p className='max-w-xl lg:ps-32 ps-10'>
                ...
                fantasies, Lucia is prepared to take matters into her 
            </p>
        </div>
    </section>
  )
